...
@Component({
  ...
  templateUrl: './anna-university-madurai-details.component.html',
  styleUrls: ['./anna-university-madurai-details.component.css']
})
export class AnnaUniversityMaduraiDetailsComponent implements OnInit {
